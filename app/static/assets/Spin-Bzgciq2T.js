import{q as S,G as f,v as p,aT as C,H as h,d as x,s as r,bS as T,aq as k,z as $,A as v,n as m,bN as w,C as N,D as R,r as B,a5 as O}from"./index.2026051103.js";import{i as j}from"./_plugin-vue_export-helper-Cpp5inQi.js";function H(e){const{opacityDisabled:a,heightTiny:t,heightSmall:i,heightMedium:l,heightLarge:s,heightHuge:c,primaryColor:o,fontSize:n}=e;return{fontSize:n,textColor:o,sizeTiny:t,sizeSmall:i,sizeMedium:l,sizeLarge:s,sizeHuge:c,color:o,opacitySpinning:a}}const P={common:S,self:H},V=f([f("@keyframes spin-rotate",`
 from {
 transform: rotate(0);
 }
 to {
