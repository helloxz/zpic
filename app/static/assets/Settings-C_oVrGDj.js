...
`,[a("layout-scroll-container",`
 ...
 top: 0;
 bottom: 0;
 `)]),re={embedded:Boolean,position:H,nativeScrollbar:{type:Boolean,default:!0},scrollbarProps:Object,onScroll:Function,contentClass:String,contentStyle:{type:[String,Object],default:""},hasSider:Boolean,siderPlacement:{type:String,default:"left"}},D=Q("n-layout");function se(e){return C({name:e?"LayoutContent":"Layout",props:Object.assign(Object.assign({},j.props),re),setup(o){const t=w(null),g=w(null),{mergedClsPrefixRef:m,inlineThemeDisabled:b}=F(o),T=j("Layout","-layout",le,N,o,m);function L(i,d){if(o.nativeScrollbar){const{value:u}=t;u&&(d===void 0?u.scrollTo(i):u.scrollTo(i,d))}else{const{value:u}=g;u&&u.scrollTo(i,d)}}U(D,o);let z=0,_=0;const O=i=>{var d;const u=i.target;z=u.scrollLeft,_=u.scrollTop,(d=o.onScroll)===null||d===void 0||d.call(o,i)};W(()=>{if(o.nativeScrollbar){const i=t.value;i&&(i.scrollTop=_,i.scrollLeft=z)}});const k={display:"flex",flexWrap:"nowrap",width:"100%",flexDirection:"row"},B={scrollTo:L},R=p(()=>{const{common:{cubicBezierEaseInOut:i},self:d}=T.value;return{"--n-bezier":i,"--n-color":o.embedded?d.colorEmbedded:d.color,"--n-text-color":d.textColor}}),f=b?V("layout",p(()=>o.embedded?"e":""),R,o):void 0;return Object.assign({mergedClsPrefix:m,scrollableElRef:t,scrollbarInstRef:g,hasSiderStyle:k,mergedTheme:T,handleNativeElScroll:O,cssVars:b?void 0:R,themeClass:f?.themeClass,onRender:f?.onRender},B)},render(){var o;const{mergedClsPrefix:t,hasSider:g}=this;(o=this.onRender)===null||o===void 0||o.call(this);const m=g?this.hasSiderStyle:void 0,b=[this.themeClass,e&&`${t}-layout-content`,`${t}-layout`,`${t}-layout--${this.position}-positioned`];return c("div",{class:b,style:this.cssVars},this.nativeScrollbar?c("div",{ref:"scrollableElRef",class:[`${t}-layout-scroll-container`,this.contentClass],style:[this.contentStyle,m],onScroll:this.handleNativeElScroll},this.$slots):c(Y,Object.assign({},this.scrollbarProps,{onScroll:this.onScroll,ref:"scrollbarInstRef",theme:this.mergedTheme.peers.Scrollbar,themeOverrides:this.mergedTheme.peerOverrides.Scrollbar,contentClass:this.contentClass,contentStyle:[this.contentStyle,m]}),this.$slots))}})}const be=se(!1),ne=a("layout-sider",`
 flex-shrink: 0;
 box-sizing: border-box;
 position: relative;
 z-index: 1;
